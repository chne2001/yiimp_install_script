...
##############################################
#											 #
# Current Modified by chne2001 (2022-06-06)   #
# Updated by chne2001 (2022-08-01)			 #
# 											 #
##############################################
...
function install_end_message {
	...
	echo -e "$YELLOW Yiimp Installer Script Fork By chne2001 https://github.com/chne2001/yiimp_install_script $COL_RESET"
	echo -e "$CYAN  --------------------------------------------------------------------------- 	  		$COL_RESET"
...
function term_art {
	...
	echo -e "$CYAN   ----------------------------------------------------------> 	  											$COL_RESET"
	echo -e "$CYAN  |$YELLOW Yiimp Installer Script Fork By chne2001!												$COL_RESET"
...
function term_yiimpool {
	...
	figlet -f slant -w 100 "YiimpooL" | lolcat
	echo -e "$CYAN   -----------------|--------------------- 	  											$COL_RESET"
	echo -e "$YELLOW  Yiimp Installer Script Fork By chne2001!												$COL_RESET"
...
function last_words {
	...
	echo "<-------------------------------------|--------------------------------------->"
	echo -e "$YELLOW Thank you for using Yiimp Install Script $VERSION fork by chne2001!      $COL_RESET"
	echo
	echo -e "$YELLOW =>  To run this installer anytime simply type:$GREEN yiimpool         $COL_RESET"
