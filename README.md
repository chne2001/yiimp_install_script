...
<p align="center">
  ...
  <img alt="GitHub issues" src="https://img.shields.io/github/issues/chne2001/yiimp_install_script">
  <img alt="GitHub release (latest by date)" src="https://img.shields.io/github/v/release/chne2001/yiimp_install_script">
</p>
<p align="center">
...
```
curl https://raw.githubusercontent.com/chne2001/yiimp_install_script/master/install.sh | bash
